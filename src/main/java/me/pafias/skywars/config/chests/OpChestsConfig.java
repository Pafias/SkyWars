...
public class OpChestsConfig {

    public static YamlConfiguration config = null;
    public static File configFile = null;
    File configYml = new File("plugins//SkyWars//op-chests.yml");
    FileConfiguration configConfig = YamlConfiguration.loadConfiguration(configYml);

    public static void reloadConfig() {
        if (configFile == null) {
            configFile = new File("plugins//SkyWars//op-chests.yml");
        }
        config = YamlConfiguration.loadConfiguration(configFile);

        InputStream defConfigStream = Bukkit.getPluginManager().getPlugin("SkyWars").getResource("op-chests.yml");
